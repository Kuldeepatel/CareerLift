...
const EmployeeSignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:8000/api/v1/employee/signup', data, {
        headers: {
  ...
  return (
    <>
      ...
      <div className="ml-[18%] z-10 pt-[60px] flex flex-col w-[100-18%] h-full p-4 bg-white mt-10">
        <h1 className="text-2xl p-6 bg-white w-full text-slate-600">Employee Registration</h1>
